    ...
    stage('Promoting release v5.0') {
      ...
      stages {
        stage('Generating release') {
          steps {
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-gtk-sp:latest registry.sonata-nfv.eu:5000/tng-gtk-sp:v5.0'
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-gtk-sp:latest sonatanfv/tng-gtk-sp:v5.0'
            sh 'docker push registry.sonata-nfv.eu:5000/tng-gtk-sp:v5.0'
            sh 'docker push sonatanfv/tng-gtk-sp:v5.0'
          }
        }
